...
public class RechercherAdherant extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Search Adherant");
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        String requet1 = "select * from adherant where email ='"+UserName+"'";
         try {
             Statement st= con.createStatement();
             rs = st.executeQuery(requet1);
            if (rs.next()) {
                user=rs.getInt("id_adherant");
                dispose();
                new UpdateFormA(user).setVisible(true);
            } 
            else 
            {
