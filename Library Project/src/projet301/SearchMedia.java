...
public class SearchMedia extends javax.swing.JFrame {
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        String requet1 = "select * from media where NAME ='" + Name + "'";
        try {
            Statement st = con.createStatement();
            rs = st.executeQuery(requet1);
            if (rs.next()) {
                media = rs.getInt("id_media");
                dispose();
                new showMedia(user, media).setVisible(true);
            } else {
                JOptionPane.showMessageDialog(this, "Media not exist ");
                name.setText("");
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchMedia().setVisible(true);
            }
        });
    }
